...
const CSS_URL_DEFAULT = "http://localhost:8000/index.css";
...
CUS_addElement(document.getElementsByClassName('panel')[0],'div',{
    class: 'project'
},true).innerHTML = '&ensp;' + 
  '<span>Project</span>' + 
  '<span class="ico">' + 
...
CUS_addElement(document.getElementsByClassName('main')[0],'div',{
    class: 'ide-foot'
},false).innerHTML = '&ensp;' + 
  '<span class="menu bor"></span><span class="menu con" onclick="panelStyleChange()"></span><span class="menu bor"></span>' +
  '<span class="info">11:11&ensp;&ensp;CRLF&ensp;&ensp;UTF-8&ensp;&ensp;4&ensp;&ensp;spaces&ensp;&ensp;V&ensp;&ensp;lock&ensp;&ensp;' + 
