...
(function() {
	...
	function t(a, b) {
		...
		for (var d = "",
			e = a.length - 1,
			f = 0; f < e; f++) d += a[f] + (f < b.length ? b[f] : "%s");
		r.call(this, d + a[e])
	}
	k(t, r);
	...
	function _getCallbackFunction(a) {
		a: {
			a = a.split(".");
			for (var b = g,
				d = 0; d < a.length; d++) if (b = b[a[d]], null == b) {
					a = null;
					break a
				}
			a = b
	...
	function _loadJs(a) {
		...
		a = new y(a, z);
		a instanceof y && a.constructor === y ? a = a.g: (b = typeof a, u("expected object of type TrustedResourceUrl, got '" + a + "' of type " + ("object" != b ? b: a ? Array.isArray(a) ? "array": b: "null")), a = "type_error:TrustedResourceUrl");
		d.src = a;
		var f;
		a = (d.ownerDocument && d.ownerDocument.defaultView || window).document; (f = (a = null === (f = a.querySelector) || void 0 === f ? void 0 : f.call(a, "script[nonce]")) ? a.nonce || a.getAttribute("nonce") || "": "") && d.setAttribute("nonce", f);
		A(d)
	}
	function _loadCss(a) {
	...
	function _isNS(a) {
		a = a.split(".");
		for (var b = window,
			d = 0; d < a.length; ++d) if (! (b = b[a[d]])) return ! 1;
		return ! 0
	}
	function _setupNS(a) {
		a = a.split(".");
		for (var b = window,
			d = 0; d < a.length; ++d) b.hasOwnProperty ? b.hasOwnProperty(a[d]) ? b = b[a[d]] : b = b[a[d]] = {}: b = b[a[d]] || (b[a[d]] = {});
		return b
	}
	...
	if (_isNS('google.translate.Element')) {
		...
		c._pci = 'https://cdn.jsdelivr.net/gh/cacaos/violentmonkey-script@main/google-translate/translate.google.com/translate_static/img/te_ctrl3.gif';
		c._pci = '';
		c._pli = b + '/translate_static/img/loading.gif';
		c._pli = 'https://cdn.jsdelivr.net/gh/cacaos/violentmonkey-script@main/google-translate/translate.google.com/translate_static/img/loading.gif';
		c._plla = h + '/translate_a/l';
		c._pmi = b + '/translate_static/img/mini_google.png';
		c._ps = b + '/translate_static/css/translateelement.css';
		c._ps = 'https://cdn.jsdelivr.net/gh/cacaos/violentmonkey-script@main/google-translate/translate.google.com/translate_static/css/translateelement.css';
		c._puh = 'translate.google.com';
		_loadCss(c._ps);
		_loadJs('https://cdn.jsdelivr.net/gh/cacaos/violentmonkey-script@main/google-translate/translate.google.com/translate_static/js/element/main_zh-CN.js');
	})();
})();
